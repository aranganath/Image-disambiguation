...
class CIFAR10Transformer(nn.Module):
    '''
        Any
    '''
    def __init__(self, 
        ...
        self.d_model = d_model
        self.Downsampler = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=16, stride=1, padding=1, kernel_size=(3,3)),
            nn.BatchNorm2d(16),
            nn.ReLU(),
            nn.Conv2d(in_channels=16, out_channels=32, stride=1, padding=1, kernel_size=(3,3)),
            nn.BatchNorm2d(32),
        ...
        self.upsampler = nn.Sequential(
            ...
            nn.BatchNorm2d(8),
            nn.ReLU(),
            nn.ConvTranspose2d(in_channels=8, out_channels=3, stride=1, padding=1, kernel_size=(3,3)),
            nn.BatchNorm2d(2),
        )
